...
* Contributors:
*
* Description:  PowerStateTest class member functions
*
*/
...
// -----------------------------------------------------------------------------
// CPowerStateTest::CPowerStateTest
...
// -----------------------------------------------------------------------------
//
void CPowerStateTest::ConstructL()
    {
    iLog = CStifLogger::NewL( KPowerStateTestLogPath, 
                          KPowerStateTestLogFile);

	myActiveScheduler = new CActiveScheduler;
	CActiveScheduler::Install(myActiveScheduler);
	
    // Sample how to use logging
    _LIT( KLogStart, "PowerStateTest logging starts!" );
    iLog->Log( KLogStart );

    }
//-----------------------------------------------------------------------------
// CPowerStateTest::SendTestClassVersion
// Method used to send version of test class
//-----------------------------------------------------------------------------
//
void CPowerStateTest::SendTestModuleVersion()
	{
	...
	moduleName = _L("PowerStateTest.dll");
...
// -----------------------------------------------------------------------------
// CPowerStateTest::NewL
// Two-phased constructor.
// -----------------------------------------------------------------------------
//
CPowerStateTest* CPowerStateTest::NewL()
    {
    CPowerStateTest* self = new (ELeave) CPowerStateTest;
...
// -----------------------------------------------------------------------------
// CPowerStateTest::InitL
// InitL is used to initialize the Test Module.
// -----------------------------------------------------------------------------
//
TInt CPowerStateTest::InitL( 
    TFileName& /*aIniFile*/, 
    TBool /*aFirstTime*/ )
    {
    return KErrNone;
...
// -----------------------------------------------------------------------------
//
TInt CPowerStateTest::GetTestCasesL( 
...
// -----------------------------------------------------------------------------
// CPowerStateTest::RunTestCaseL
// RunTestCaseL is used to run an individual test case specified 
// by aTestCase. Test cases that can be run may be requested from 
// Test Module by GetTestCases method before calling RunTestCase.
// -----------------------------------------------------------------------------
//
TInt CPowerStateTest::RunTestCaseL( 
...
// -----------------------------------------------------------------------------
// CPowerStateTest::OOMTestQueryL
// Used to check if a particular test case should be run in OOM conditions and 
// which memory allocations should fail.    
// -----------------------------------------------------------------------------
//
TBool CPowerStateTest::OOMTestQueryL( 
    ...
    {
    _LIT( KLogOOMTestQueryL, "CPowerStateTest::OOMTestQueryL" );
...
// -----------------------------------------------------------------------------
// CPowerStateTest::OOMTestInitializeL
...
// -----------------------------------------------------------------------------
//
void CPowerStateTest::OOMTestInitializeL( 
                                const TFileName& /* aTestCaseFile */, 
                                const TInt /* aCaseNumber */ )
    {
    }
...
// -----------------------------------------------------------------------------
// CPowerStateTest::OOMHandleWarningL
...
// -----------------------------------------------------------------------------
//
void CPowerStateTest::OOMHandleWarningL( 
                                const TFileName& /* aTestCaseFile */,
                                const TInt /* aCaseNumber */, 
                                TInt& /* aFailNextValue */ )
    {
...
// -----------------------------------------------------------------------------
// CPowerStateTest::OOMTestFinalizeL
...
// -----------------------------------------------------------------------------
//
void CPowerStateTest::OOMTestFinalizeL( 
                                const TFileName& /* aTestCaseFile */, 
                                const TInt /* aCaseNumber */ )
    {
    }
