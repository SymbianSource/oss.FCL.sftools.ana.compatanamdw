...
class CBrCtlBCTestObserver : public CBase, public MBrCtlLayoutObserver,
public MBrCtlSoftkeysObserver, public MBrCtlSpecialLoadObserver,
public MBrCtlLoadEventObserver, public MBrCtlLinkResolver,
public MBrCtlDownloadObserver
    ...
    public:  // Constructors and destructor
        ...
        */
        static CBrCtlBCTestObserver* NewL();

        /**
        * Destructor.
        */
        ~CBrCtlBCTestObserver();
