...
#ifndef MTPBKEMAILOVERSMS_H
#define MTPBKEMAILOVERSMS_H
...
class CPbkEmailOverSmsAddressSelect;
...
// Logging path
_LIT( KMTPbkEmailOverSmsLogPath, "\\logs\\testframework\\MTPbkEmailOverSms\\" ); 
// Log file
_LIT( KMTPbkEmailOverSmsLogFile, "MTPbkEmailOverSms.txt" ); 
_LIT( KMTPbkEmailOverSmsLogFileWithTitle, "MTPbkEmailOverSms_[%S].txt" );
...
/**
*  CMTPbkEmailOverSms test class for STIF Test Framework TestScripter.
*  ?other_description_lines
*
*  @lib ?library
*  @since ?Series60_version
*/
NONSHARABLE_CLASS(CMTPbkEmailOverSms) : public CScriptBase
    {
    public:  // Constructors and destructor
        ...
        */
        static CMTPbkEmailOverSms* NewL( CTestModuleIf& aTestModuleIf );

        /**
        * Destructor.
        */
        virtual ~CMTPbkEmailOverSms();
    ...
    private:
        ...
        */
        CMTPbkEmailOverSms( CTestModuleIf& aTestModuleIf );
    ...
    private:    // Data
        ...
        CPbkEmailOverSmsAddressSelect*	iEmailOverSmsAddressSelect;
