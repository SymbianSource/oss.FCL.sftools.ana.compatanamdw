...
TInt CTestDouble_blr::acos_test()
	{
	// Create temporary variables in stack
  	char chParam[MAX_SIZE];
  	FLOAT input;
...
TInt CTestDouble_blr::acosh_test()
	{
 	// Create temporary variables in stack
  	char chParam[MAX_SIZE];
  	FLOAT input;
...
TInt CTestDouble_blr::asin_test()
	{
 	// Create temporary variables in stack
  	char chParam[MAX_SIZE];
  	FLOAT input;
...
TInt CTestDouble_blr::asinh_test()
	{
 	// Create temporary variables in stack
  	char chParam[MAX_SIZE];
  	FLOAT input;
...
TInt CTestDouble_blr::atan_test()
	{
 	// Create temporary variables in stack
  	char chParam[MAX_SIZE];
  	FLOAT input;
...
TInt CTestDouble_blr::atanh_test()
	{
 	// Create temporary variables in stack
  	char chParam[MAX_SIZE];
  	FLOAT input;
...
TInt CTestDouble_blr::sinh_test()
	{	
	char chParam[MAX_SIZE];
  	FLOAT input;
  	FLOAT expected;
...
TInt CTestDouble_blr::cosh_test()
	{
 	// Create temporary variables in stack
  	char chParam[MAX_SIZE];
  	FLOAT input;
...
TInt CTestDouble_blr::tanh_test()
	{	
	char chParam[20];
  	FLOAT input;
  	FLOAT expected;
...
TInt CTestDouble_blr::atan2_test()
	{
 	// Create temporary variables in stack
  	char chParam[MAX_SIZE];
  	FLOAT input1;
