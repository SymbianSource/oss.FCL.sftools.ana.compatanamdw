...
#ifndef __TESTSEMTIMEDWAIT_H__
#define __TESTSEMTIMEDWAIT_H__
...
_LIT(KTestSem291, "TestSem291");
_LIT(KTestSem292, "TestSem292");
_LIT(KTestSem303, "TestSem303");
_LIT(KTestSem304, "TestSem304");
_LIT(KTestSem305, "TestSem305");
_LIT(KTestSem306, "TestSem306");
_LIT(KTestSem701, "TestSem701");
_LIT(KTestSem702, "TestSem702");


class CTestSemtimedwait : public CTestStep
	{
public:
	~CTestSemtimedwait(); 
	CTestSemtimedwait(const TDesC& aStepName);
