...
_LIT(KMidiStateClosedDisengaged,			"EClosedDisengaged");
_LIT(KMidiStateOpenDisengaged,				"EOpenDisengaged");
_LIT(KMidiStateOpenPlaying,					"EOpenPlaying");
_LIT(KMidiStateClosedEngaged,				"EClosedEngaged");
_LIT(KMidiStateOpenEngaged,					"EOpenEngaged");
...
TBool CT_MMUtil::ReadMidiState(CDataWrapper& aDataWrapper, const TDesC& aSection, const TDesC& aKeyName, TMidiState& aState)
	...
	if ( ret )
		...
		if ( str==KMidiStateClosedDisengaged )
			{
			aState=EClosedDisengaged;
			}
		else if ( str==KMidiStateOpenDisengaged )
			{
			aState=EOpenDisengaged;
			}
