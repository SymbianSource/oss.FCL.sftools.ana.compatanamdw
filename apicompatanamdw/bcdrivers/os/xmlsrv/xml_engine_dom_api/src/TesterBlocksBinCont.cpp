...
* Contributors:
*
* Description:  Binary Container test cases
*
*/
...
// -----------------------------------------------------------------------------
// CDomBCTester::BinaryContainerL
// test binary container method function.
// (other items were commented in a header).
// -----------------------------------------------------------------------------
//

TInt CDomBCTester::BinaryContainerL(CStifItemParser& aItem)
{
...
// -----------------------------------------------------------------------------
// CDomBCTester::TestCreateBinaryContainerL
// test craeting binary container
// (other items were commented in a header).
// -----------------------------------------------------------------------------
//

TInt CDomBCTester::TestCreateBinaryContainerL( TPtrC8 aCid, TPtrC8 binaryDataPtr, TPtrC pOut )
{
...
// -----------------------------------------------------------------------------
// CDomBCTester::TestLenghtOfBinaryContainerL
// test functin lenght of binary container
// (other items were commented in a header).
// -----------------------------------------------------------------------------
//
TInt CDomBCTester::TestSizeOfBinaryContainerL( RXmlEngDocument& iDocument, TPtrC8 aCid, TPtrC8 binaryDataPtr, TInt size )
{
    TInt aLength(-1);
    TXmlEngBinaryContainer binaryDataNode = iDocument.CreateBinaryContainerL( aCid, binaryDataPtr );
...
// -----------------------------------------------------------------------------
// CDomBCTester::TestBinaryContainerNodeTypeL
// check if created binary container is a text node
// (other items were commented in a header).
// -----------------------------------------------------------------------------
//

TInt CDomBCTester::TestBinaryContainerNodeTypeL( RXmlEngDocument& iDocument, TPtrC8 aCid, TPtrC8 binaryDataPtr )
{
    //  create binary container
    TXmlEngBinaryContainer binaryDataNode = iDocument.CreateBinaryContainerL( aCid, binaryDataPtr );
...
// -----------------------------------------------------------------------------
// CDomBCTester::TestSetContentsOfBinaryContainerL
// check if function SetContentsL & Contents of Binary Container
// (other items were commented in a header).
// -----------------------------------------------------------------------------
//

TInt CDomBCTester::TestContentsOfBinaryContainerL( RXmlEngDocument& iDocument, TPtrC8 aCid, TPtrC8 binaryDataPtr, TPtrC pOut1 )
{
    TXmlEngBinaryContainer binaryDataNode = iDocument.CreateBinaryContainerL( aCid, binaryDataPtr );
...
// -----------------------------------------------------------------------------
// CDomBCTester::TestMoveBinaryContainerL
// test craeting binary container
// (other items were commented in a header).
// -----------------------------------------------------------------------------
//

TInt CDomBCTester::TestMoveBinaryContainerL( RXmlEngDocument& iDoc1, RXmlEngDocument& iDoc2, TPtrC8 aCid, TPtrC8 binaryDataPtr , TPtrC pOut1, TPtrC pOut2)
{
    TInt error;
...
// -----------------------------------------------------------------------------
// CDomBCTester::TestremoveBinaryContainerL
// test craeting binary container
// (other items were commented in a header).
// -----------------------------------------------------------------------------
//

TInt CDomBCTester::TestRemoveBinaryContainerL( RXmlEngDocument& iDocument,TPtrC8 aCid,
...
// -----------------------------------------------------------------------------
// CDomBCTester::TestCopyBinaryContainerL
// test craeting binary container
// (other items were commented in a header).
// -----------------------------------------------------------------------------
//

TInt CDomBCTester::TestCopyBinaryContainerL( RXmlEngDocument& iDocument,TPtrC8 aCid, TPtrC8 binaryDataPtr, TPtrC pOut1, TPtrC pOut2 )
{
    TXmlEngBinaryContainer binaryDataNode = iDocument.CreateBinaryContainerL( aCid, binaryDataPtr );
    iDocument.DocumentElement().FirstChild().NextSibling().AppendChildL(binaryDataNode);
    User::LeaveIfError( SaveDocumentL (iDocument, pOut1 ) );
...
// -----------------------------------------------------------------------------
// CDomBCTester::TestReplaceBinaryContainerL
// test craeting binary container
// (other items were commented in a header).
// -----------------------------------------------------------------------------
//

TInt CDomBCTester::TestReplaceBinaryContainerL( RXmlEngDocument& iDoc1, RXmlEngDocument& iDoc2,
...
// -----------------------------------------------------------------------------
// CDomBCTester::PartialBinaryContainerL
// test binary container method function.
// (other items were commented in a header).
// -----------------------------------------------------------------------------
//
TInt CDomBCTester::PartialBinaryContainerL(CStifItemParser& aItem)
{
...
// -----------------------------------------------------------------------------
// CDomBCTester::TestAppendContentsL
// test appending contents to binary container
// (other items were commented in a header).
// -----------------------------------------------------------------------------
//

TInt CDomBCTester::TestAppendContentsL(CStifItemParser& aItem)
{
    TPtrC pData;
...
// -----------------------------------------------------------------------------
// CDomBCTester::BinaryContainer_GetListL
// test method function.
// (other items were commented in a header).
// -----------------------------------------------------------------------------
//
TInt CDomBCTester::BinaryContainer_GetListL( CStifItemParser& aItem )
{
    ...
    TPtrC pInputFile1;
    aItem.GetNextString(pInputFile1);
    HBufC8* str1=ReadFileL(pInputFile1);
...
// -----------------------------------------------------------------------------
// CDomBCTester::BinaryContainer_GetList2L
// test method function.
// (other items were commented in a header).
// -----------------------------------------------------------------------------
//
TInt CDomBCTester::BinaryContainer_GetList2L( CStifItemParser& aItem )
{
...
// -----------------------------------------------------------------------------
// CDomBCTester::BinaryContainer_CidL
// test method function.
// (other items were commented in a header).
// -----------------------------------------------------------------------------
//
TInt CDomBCTester::BinaryContainer_CidErrorL( CStifItemParser& aItem )
{
    ...
    aItem.GetNextString(pInputFile1);
    TPtrC pInputFile2;
    aItem.GetNextString(pInputFile2);
    TPtrC pInputFile3;
    aItem.GetNextString(pInputFile3);
            
    HBufC8* str1=ReadFileL(pInputFile1);
    CleanupStack::PushL(str1);
    HBufC8* str2=ReadFileL(pInputFile2);
    CleanupStack::PushL(str2);
    HBufC8* str3=ReadFileL(pInputFile3);
...
// -----------------------------------------------------------------------------
// CDomBCTester::BinaryContainer_RemoveL
// test method function.
// (other items were commented in a header).
// -----------------------------------------------------------------------------
//
TInt CDomBCTester::BinaryContainer_RemoveL( CStifItemParser& aItem )
{
...
// -----------------------------------------------------------------------------
// CDomBCTester::BinaryContainer_Remove2L
// test method function.
// (other items were commented in a header).
// -----------------------------------------------------------------------------
//
TInt CDomBCTester::BinaryContainer_Remove2L( CStifItemParser& aItem )
{
    //check working of Removing BinaryContainer
...
// -----------------------------------------------------------------------------
// CDomBCTester::BinaryContainer_Remove3L
// test method function.
// (other items were commented in a header).
// -----------------------------------------------------------------------------
//
TInt CDomBCTester::BinaryContainer_Remove3L( CStifItemParser& aItem )
{
    //check working of Removing BinaryContainer
    ...
    RFile file1;
    User::LeaveIfError(file1.Open(rfs, pInputFile1, EFileRead));
...
// -----------------------------------------------------------------------------
// CDomBCTester::BinaryContainer_UnlinkL
// test method function.
// (other items were commented in a header).
// -----------------------------------------------------------------------------
//
TInt CDomBCTester::BinaryContainer_UnlinkL( CStifItemParser& aItem )
{
...
// -----------------------------------------------------------------------------
// CDomBCTester::BinaryContainer_ReplaceWithL
// test method function.
// (other items were commented in a header).
// -----------------------------------------------------------------------------
//
TInt CDomBCTester::BinaryContainer_ReplaceWithL( CStifItemParser& aItem )
{
...
// -----------------------------------------------------------------------------
// CDomBCTester::BinaryContainer_SubstitiuteForL
// test method function.
// (other items were commented in a header).
// -----------------------------------------------------------------------------
//
TInt CDomBCTester::BinaryContainer_SubstituteForL( CStifItemParser& aItem )
{
...
// -----------------------------------------------------------------------------
// CDomBCTester::BinaryContainer_CopyL
// test method function.
// (other items were commented in a header).
// -----------------------------------------------------------------------------
//
TInt CDomBCTester::BinaryContainer_CopyL( CStifItemParser& aItem )
{
...
// -----------------------------------------------------------------------------
// CDomBCTester::BinaryContainer_Copy2L
// test method function.
// (other items were commented in a header).
// -----------------------------------------------------------------------------
//
TInt CDomBCTester::BinaryContainer_Copy2L( CStifItemParser& aItem )
{
    //check working of Copying containers
...
// -----------------------------------------------------------------------------
// CDomBCTester::BinaryContainer_Copy3L
// test method function.
// (other items were commented in a header).
// -----------------------------------------------------------------------------
//
TInt CDomBCTester::BinaryContainer_Copy3L( CStifItemParser& aItem )
{
    //check working of Copying containers
...
// -----------------------------------------------------------------------------
// CDomBCTester::BinaryContainer_Copy4L
// test method function.
// (other items were commented in a header).
// -----------------------------------------------------------------------------
//
TInt CDomBCTester::BinaryContainer_Copy4L( CStifItemParser& aItem )
{
    //check working of Copying containers
...
// -----------------------------------------------------------------------------
// CDomBCTester::BinaryContainer_CopyToL
// test method function.
// (other items were commented in a header).
// -----------------------------------------------------------------------------
//
TInt CDomBCTester::BinaryContainer_CopyToL( CStifItemParser& aItem )
{
...
// -----------------------------------------------------------------------------
// CDomBCTester::BinaryContainer_CloneL
// test method function.
// (other items were commented in a header).
// -----------------------------------------------------------------------------
//
TInt CDomBCTester::BinaryContainer_CloneL( CStifItemParser& aItem )
{
...
// -----------------------------------------------------------------------------
// CDomBCTester::BinaryContainer_AdoptNodeL
// test method function.
// (other items were commented in a header).
// -----------------------------------------------------------------------------
//
TInt CDomBCTester::BinaryContainer_AdoptNodeL( CStifItemParser& aItem )
{
    //check working of Clone containers
...
// -----------------------------------------------------------------------------
// CDomBCTester::BinaryContainer_SetAsFirstSiblingL
// test method function.
// (other items were commented in a header).
// -----------------------------------------------------------------------------
//
TInt CDomBCTester::BinaryContainer_SetAsFirstSiblingL( CStifItemParser& aItem )
{
...
// -----------------------------------------------------------------------------
//
TInt CDomBCTester::BinaryContainer_SetAsLastSiblingL( CStifItemParser& aItem )
{
...
// -----------------------------------------------------------------------------
// CDomBCTester::BinaryContainer_MoveBeforeSiblingL
// test method function.
// (other items were commented in a header).
// -----------------------------------------------------------------------------
//
TInt CDomBCTester::BinaryContainer_MoveBeforeSiblingL( CStifItemParser& aItem )
{
...
// -----------------------------------------------------------------------------
// CDomBCTester::BinaryContainer_MoveAfterSiblingL
// test method function.
// (other items were commented in a header).
// -----------------------------------------------------------------------------
//
TInt CDomBCTester::BinaryContainer_MoveAfterSiblingL( CStifItemParser& aItem )
{
...
// -----------------------------------------------------------------------------
// CDomBCTester::BinaryContainer_MoveToL
// test method function.
// (other items were commented in a header).
// -----------------------------------------------------------------------------
//
TInt CDomBCTester::BinaryContainer_MoveToL( CStifItemParser& aItem )
{
...
// -----------------------------------------------------------------------------
// CDomBCTester::BinaryContainer_ReconcileNamespacesL
// test method function.
// (other items were commented in a header).
// -----------------------------------------------------------------------------
//
TInt CDomBCTester::BinaryContainer_ReconcileNamespacesL( CStifItemParser& aItem )
{
