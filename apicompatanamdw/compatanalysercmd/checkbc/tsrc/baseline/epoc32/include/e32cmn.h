/*
* Copyright (c) 1994-2005 Nokia Corporation and/or its subsidiary(-ies). 
* All rights reserved.
...
@internalTechnology
 */
const TUint32 KEmulatorImageFlagAllowDllData = 0x01;	/**< @internalComponent */
...
public:
	/**
	Tests wether a given Platform Security capability is enforced by the system.
