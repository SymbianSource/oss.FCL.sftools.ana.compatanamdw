...
NONSHARABLE_CLASS(CBCTestSpeedDial) : public CScriptBase
    ...
    private:
        ...
        */
        ...
        virtual TInt TestNewL2( CStifItemParser& aItem );
        virtual TInt TestAssignDialNumberL( CStifItemParser& aItem );
        virtual TInt TestExecuteLD( CStifItemParser& aItem );
        virtual TInt TestDialNumberL( CStifItemParser& aItem );
        virtual TInt TestVoiceMailL( CStifItemParser& aItem );
        virtual TInt TestPbkEngine( CStifItemParser& aItem );
        virtual TInt TestIndex( CStifItemParser& aItem );
        virtual TInt TestNumber( CStifItemParser& aItem );
        virtual TInt TestContactId( CStifItemParser& aItem );
        virtual TInt TestPhoneDialNumber( CStifItemParser& aItem );
        virtual TInt TestPhoneNumber( CStifItemParser& aItem );
