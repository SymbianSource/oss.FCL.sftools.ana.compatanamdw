...
#ifndef __T_DATASIPUNSUPPORTEDHEADER_H__
#define __T_DATASIPUNSUPPORTEDHEADER_H__

#include "t_csiptokenheaderbase.h"
#include <testexecutestepbase.h>
#include <sipunsupportedheader.h> 

class CT_DataUnsupportedHeader : public CT_DataSIPTokenHeaderBase 
    {
public:
	virtual TBool DoCommandL(const TTEFFunction& aCommand, const TTEFSectionName& aSection, const TInt aAsyncErrorIndex);
	~CT_DataUnsupportedHeader();
	static CT_DataUnsupportedHeader* NewL();
...
private:
    CSIPUnsupportedHeader* iSIPUnsupportedHeader;
    TBool iIsOwner;
    };

#endif /*__T_DATASIPUNSUPPORTEDHEADER_H__*/
