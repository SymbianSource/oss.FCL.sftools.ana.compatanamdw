...
#ifndef __TESTSEMDESTROY_H__
#define __TESTSEMDESTROY_H__
...
_LIT(KTestSem275, "TestSem275");
_LIT(KTestSem276, "TestSem276");
_LIT(KTestSem277, "TestSem277");
_LIT(KTestSem278, "TestSem278");
_LIT(KTestSem649, "TestSem649");
_LIT(KTestSem703, "TestSem703");
_LIT(KTestSem704, "TestSem704");
_LIT(KTestSem705, "TestSem705");

class CTestSemdestroy : public CTestStep
	{
public:
	~CTestSemdestroy(); 
	CTestSemdestroy(const TDesC& aStepName);
