...
NONSHARABLE_CLASS( CAccMonitoringTestModule ): public CTestModuleBase,
    ...
    private:
        ...
        */
        ...
        /**
        * Tests:
        *   ConnectedTestL() fucntion.
        * @since    5.0
        * @param    aResult: Test case result (PASS/FAIL)
        * @return   Symbian OS error code (test case execution error 
        *           that is not returned as test case result in aResult)
        */
        TInt ConnectedTestL( TTestResult& aResult );

        /**
        * Tests:
        *   DisconnectedTestL() fucntion.
        * @since    5.0
        * @param    aResult: Test case result (PASS/FAIL)
        * @return   Symbian OS error code (test case execution error 
        *           that is not returned as test case result in aResult)
        */
        TInt DisconnectedTestL( TTestResult& aResult );

       /**
        * Tests:
        *   AccMonitorTestNoL() fucntion.
        * @since    5.0
        * @param    aResult: Test case result (PASS/FAIL)
        * @return   Symbian OS error code (test case execution error 
        *           that is not returned as test case result in aResult)
        ...
        *           that is not returned as test case result in aResult)
        */
        TInt IsObservingL( TTestResult& aResult );
        ...
        *           that is not returned as test case result in aResult)
        */
        TInt GetCapabilityValueL( TTestResult& aResult );
        ...
        */
        TInt GetDeviceTypeInfoL( TTestResult& aResult );
        ...
        * @return   Symbian OS error code (to show if the connect was successful)
        */
        TInt GetDeviceAddressInfoL( TTestResult& aResult );
        ...
        * @return   Symbian OS error code (to show if the connect was successful)
        */
        TInt GetPhysicalConInfoL( TTestResult& aResult );
        ...
        * @return   Symbian OS error code (to show if the connect was successful)
        */
        TInt AccCapabilityAtIndexL( TTestResult& aResult );
        ...
        * @return   Symbian OS error code (to show if the connect was successful)
        */
        TInt CountInfoL( TTestResult& aResult );
        ...
        * @return   Symbian OS error code (to show if the connect was successful)
        */
        TInt ExistsL( TTestResult& aResult );
        ...
        * @return   Symbian OS error code (to show if the connect was successful)
        */
        TInt ExistsArrayL( TTestResult& aResult );
        ...
        * @return   Symbian OS error code (to show if the connect was successful)
        */
        TInt CreateInstancesL( TTestResult& aResult );
        ...
        * @return   Symbian OS error code (to show if the connect was successful)
        */
        TInt CopyTestL( TTestResult& aResult );
        ...
        * @return   Symbian OS error code (to show if the connect was successful)
        */
        TInt CompareTestL( TTestResult& aResult );
