...
#ifndef __TESTCONDDESTROY_H__
#define __TESTCONDDESTROY_H__
...
_LIT(KTestCond447, "TestCond447");
_LIT(KTestCond448, "TestCond448");
_LIT(KTestCond449, "TestCond449");
_LIT(KTestCond450, "TestCond450");
_LIT(KTestCond451, "TestCond451");
_LIT(KTestCond651, "TestCond651");
_LIT(KTestCond674, "TestCond674");

class CTestConddestroy : public CTestStep
	{
public:
	~CTestConddestroy(); 
	CTestConddestroy(const TDesC& aStepName);
