...
* Contributors:
*
* Description:  FavouritesBCTest test module.
*
*/



#ifndef FAVOURITESBCTEST_H
#define FAVOURITESBCTEST_H
...
// Logging path
_LIT( KFavouritesBCTestLogPath, "\\logs\\testframework\\FavouritesBCTest\\" ); 
// Log file
_LIT( KFavouritesBCTestLogFile, "FavouritesBCTest.txt" ); 
...
typedef TInt (CFavouritesBCTest::* TestFunction)(TTestResult&);    
...
*  @since ?Series60_version
*/
//NONSHARABLE_CLASS(CFavouritesBCTest) : public CTestModuleBase,
//                                       public MRfsApMapper
NONSHARABLE_CLASS(CFavouritesBCTest) : public CTestModuleBase
    {
    public:  // Constructors and destructor
        ...
        */
        static CFavouritesBCTest* NewL();

        /**
        * Destructor.
        */
        virtual ~CFavouritesBCTest();
