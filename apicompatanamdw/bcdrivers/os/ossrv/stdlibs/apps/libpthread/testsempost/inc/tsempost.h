...
#ifndef __TESTSEMPOST_H__
#define __TESTSEMPOST_H__
...
_LIT(KTestSem279, "TestSem279");
_LIT(KTestSem280, "TestSem280");
_LIT(KTestSem281, "TestSem281");
_LIT(KTestSem282, "TestSem282");
_LIT(KTestSem283, "TestSem283");
_LIT(KTestSem284, "TestSem284");

_LIT(KTestSem697, "TestSem697");
_LIT(KTestSem698, "TestSem698");




class CTestSempost : public CTestStep
	{
public:
	~CTestSempost(); 
	CTestSempost(const TDesC& aStepName);
