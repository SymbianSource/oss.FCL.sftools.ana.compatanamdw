...
#ifndef __TESTSEMWAIT_H__
#define __TESTSEMWAIT_H__
...
_LIT(KTestFramework, "TestFramework");
_LIT(KTestOnce1682, "TestOnce1682");
_LIT(KTestOnce324, "TestOnce324");
_LIT(KTestOnce325, "TestOnce325");
_LIT(KTestOnce326, "TestOnce326");
_LIT(KTestOnce327, "TestOnce327");
_LIT(KTestOnce328, "TestOnce328");
_LIT(KTestOnce329, "TestOnce329");

class CTestPthreadonce : public CTestStep
	{
public:
	~CTestPthreadonce(); 
	CTestPthreadonce(const TDesC& aStepName);
