...
// -----------------------------------------------------------------------------
//
Ctutility* Ctutility::NewL( 
    CTestModuleIf& aTestModuleIf )
    {
    Ctutility* self = new (ELeave) Ctutility( aTestModuleIf );
...
EXPORT_C CScriptBase* LibEntryL( 
    ...
    return ( CScriptBase* ) Ctutility::NewL( aTestModuleIf );

    }

//-----------------------------------------------------------------------------
// Ctutility::SendTestClassVersion
// Method used to send version of test class
//-----------------------------------------------------------------------------
//
void Ctutility::SendTestModuleVersion()
	{
