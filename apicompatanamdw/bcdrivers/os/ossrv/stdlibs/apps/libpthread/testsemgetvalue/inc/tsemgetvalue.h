...
#ifndef __TESTSEMGETVALUE_H__
#define __TESTSEMGETVALUE_H__
...
_LIT(KTestSem313, "TestSem313");
_LIT(KTestSem314, "TestSem314");
_LIT(KTestSem315, "TestSem315");
_LIT(KTestSem316, "TestSem316");
_LIT(KTestSem317, "TestSem317");
_LIT(KTestSem318, "TestSem318");
_LIT(KTestSem319, "TestSem319");


class CTestSemgetvalue : public CTestStep
	{
public:
	~CTestSemgetvalue(); 
	CTestSemgetvalue(const TDesC& aStepName);
