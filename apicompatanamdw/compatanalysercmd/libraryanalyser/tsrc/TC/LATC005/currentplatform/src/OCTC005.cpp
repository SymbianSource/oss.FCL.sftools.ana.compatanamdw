...
EXPORT_C void COCTC005::Func2(TUint a)
	{
    iI = a+1;
	}
	
// Change parameters to const
EXPORT_C TInt COCTC005::Func3( char const* const c1, char const* const* const c2 )
    {
    if( c1 == 0 )
        return 0;
...
EXPORT_C TInt COCTC005::Func4( char* c1, char** c2 )
    {
    if( c1 == 0 )
        return 0;
...
EXPORT_C TInt COCTC005::Func5( TInt (*pF) (char const* c1), char* c2 )
    {
    return pF(c2);
    }
