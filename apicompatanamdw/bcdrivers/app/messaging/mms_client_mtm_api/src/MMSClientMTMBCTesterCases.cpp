...
const TCaseInfo CMMSClientMTMBCTester::Case ( const TInt aCaseNumber ) const 
    ...
    static TCaseInfoInternal const KCases[] =
        {
        ENTRY( "Creating a new message entry", CMMSClientMTMBCTester::CreateMessageEntry ),
        
        ENTRY( "Creating a new service entry", CMMSClientMTMBCTester::CreateServiceEntry ),
...
***/
        ...
        ENTRY( "Handling the MMS settings", &CMMSClientMTMBCTester::HandleMMSSettings ),

#endif // MMSCLIENTMTMBCTESTER_INTERNAL_TESTING

        ENTRY( "Storing MMS settings to disk", CMMSClientMTMBCTester::StoreMMSSettings ),
        ENTRY( "Restoring MMS settings from disk", CMMSClientMTMBCTester::RestoreMMSSettings ),
        ENTRY( "Restoring factory MMS settings", CMMSClientMTMBCTester::RestoreFactoryMMSSettings ),
        ENTRY( "Validating default service", CMMSClientMTMBCTester::ValidateDefaultService ),
        ENTRY( "Handling the sender", CMMSClientMTMBCTester::Sender),
        ENTRY( "Handling the message class", CMMSClientMTMBCTester::MessageClass ),
        ENTRY( "Handling the expiration interval", CMMSClientMTMBCTester::ExpirationInterval ),
        ENTRY( "Handling the expiration date", CMMSClientMTMBCTester::ExpirationDate ),
        ENTRY( "Handling the delivery time interval", CMMSClientMTMBCTester::DeliveryTimeInterval ),
        ENTRY( "Handling the delivery date", CMMSClientMTMBCTester::DeliveryDate ),
        ENTRY( "Handling the message priority", CMMSClientMTMBCTester::MessagePriority ),
        ENTRY( "Handling the sender visibility", CMMSClientMTMBCTester::SenderVisibility ),
        ENTRY( "Handling the delivery report request", CMMSClientMTMBCTester::DeliveryReportRequest ),
        ENTRY( "Handling the read reply request", CMMSClientMTMBCTester::ReadReplyRequest ),
        ENTRY( "Getting the sending date and time", CMMSClientMTMBCTester::SendingDate ),
        ENTRY( "Getting the response text", CMMSClientMTMBCTester::ResponseText ),
        ENTRY( "Getting the response status", CMMSClientMTMBCTester::ResponseStatus ),
        ENTRY( "Getting the number of previous senders",
               CMMSClientMTMBCTester::NumberOfPreviousSenders ),
        ENTRY( "Getting the address of a previous sender", CMMSClientMTMBCTester::PreviousSender ),
        ENTRY( "Getting a previous sending date", CMMSClientMTMBCTester::PreviousSendingDate ),
        ENTRY( "Getting the receive time", CMMSClientMTMBCTester::ReceiveTime ),
        ENTRY( "Getting the actual message size", CMMSClientMTMBCTester::TransferSize ),
        ENTRY( "Getting the location of the message", CMMSClientMTMBCTester::ContentLocation ),
        ENTRY( "Handling the message root part MMS header", CMMSClientMTMBCTester::MessageRootPart ),
        ENTRY( "Handling the maximum image size MMS header", CMMSClientMTMBCTester::MaximumImageSize ),
        
        ENTRY( "Getting the message size", CMMSClientMTMBCTester::GetMessageSize ),
        ENTRY( "Setting the message description", CMMSClientMTMBCTester::SetMessageDescription ),
        
        ENTRY( "Adding a new attribute", CMMSClientMTMBCTester::AddNewAttribute),
        ENTRY( "Getting an attribute", CMMSClientMTMBCTester::GetAttribute),
        ENTRY( "Checking if an attribute exists", CMMSClientMTMBCTester::FindAttribute ),
        ENTRY( "Deleting an attribute", CMMSClientMTMBCTester::DeleteAttribute ),
        ENTRY( "Resetting all attributes", CMMSClientMTMBCTester::ResetAttributes ),
        
        ENTRY( "Creating an attachment synchronously", CMMSClientMTMBCTester::CreateAttachmentSync ),
        ENTRY( "Creating a text attachment", CMMSClientMTMBCTester::CreateTextAttachment ),
        
        ENTRY( "Sending a message", CMMSClientMTMBCTester::SendMessage ),
        ENTRY( "Sending a selection of messages", CMMSClientMTMBCTester::SendMessageSelection ),
        ENTRY( "Fetching all available messages", CMMSClientMTMBCTester::FetchAllMessages ),
        
        ENTRY( "Getting the type of the MTM", CMMSClientMTMBCTester::GetMTMType ),
        
        ENTRY( "Setting the context", CMMSClientMTMBCTester::SetContext ),
        ENTRY( "Switching the context", CMMSClientMTMBCTester::SwitchContext ),
        ENTRY( "Checking if the context has been set", CMMSClientMTMBCTester::CheckContext ),
        
        ENTRY( "Restoring and storing current entry data", CMMSClientMTMBCTester::RestoreAndStore ),
        ENTRY( "Validating the current message", CMMSClientMTMBCTester::ValidateMessage ),
        ENTRY( "Searching for a specified text in the current message",
               CMMSClientMTMBCTester::SearchForText ),
        ENTRY( "Creating a reply message", CMMSClientMTMBCTester::CreateReply ),
        ENTRY( "Creating a forward message", CMMSClientMTMBCTester::CreateForward ),
        ENTRY( "Adding an addressee", CMMSClientMTMBCTester::AddAddressee ),
        ENTRY( "Adding an addressee with an alias", CMMSClientMTMBCTester::AddAddresseeAlias ),
        ENTRY( "Adding a typed addressee", CMMSClientMTMBCTester::AddAddresseeTyped ),
        ENTRY( "Adding a typed addressee with an alias",
               CMMSClientMTMBCTester::AddAddresseeAliasTyped ),
        ENTRY( "Removing an addressee", CMMSClientMTMBCTester::RemoveAddressee ),
        ENTRY( "Accessing the message body", CMMSClientMTMBCTester::AccessMessageBody ),
        ENTRY( "Accessing the message body, const version",
               CMMSClientMTMBCTester::AccessMessageBodyConst ),
        ENTRY( "Handling the message subject", CMMSClientMTMBCTester::HandleMessageSubject ),
        
        ENTRY( "Querying for a capability", CMMSClientMTMBCTester::QueryCapability ),
        ENTRY( "Invoking a synchronous function", CMMSClientMTMBCTester::InvokeSynchronousFunction ),
        ENTRY( "Invoking an asynchronous function",
               CMMSClientMTMBCTester::InvokeAsynchronousFunction ),
        ENTRY( "Getting access to the session", CMMSClientMTMBCTester::GetSession ),
        
        ENTRY( "Adding a file attachment by file path", CMMSClientMTMBCTester::AddAttachmentFilePath ),
        ...
        ENTRY( "Creating an attachment asynchronously", CMMSClientMTMBCTester::CreateAttachmentAsync ),
        ENTRY( "Canceling an attachment operation", CMMSClientMTMBCTester::CancelAttachmentOperation ),
        
        ENTRY( "Creating a new message", CMMSClientMTMBCTester::CreateMessage ),
        ENTRY( "Notifying of a BIO type change", CMMSClientMTMBCTester::NotifyBIOTypeChange ),
        ENTRY( "Removing the default service", CMMSClientMTMBCTester::RemoveDefaultService ),
        ENTRY( "Changing the default service", CMMSClientMTMBCTester::ChangeDefaultService ) 
        };
