...
_LIT(KTestSem285, "TestSem285");
_LIT(KTestSem286, "TestSem286");
_LIT(KTestSem287, "TestSem287");
_LIT(KTestSem288, "TestSem288");
_LIT(KTestSem289, "TestSem289");
_LIT(KTestSem290, "TestSem290");
_LIT(KTestSem699, "TestSem699");


class CTestSemwait : public CTestStep
	{
public:
	~CTestSemwait(); 
	CTestSemwait(const TDesC& aStepName);
