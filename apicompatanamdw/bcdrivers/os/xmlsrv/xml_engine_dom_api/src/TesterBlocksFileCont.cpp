...
/************************************** FILE ****************************************/
// -----------------------------------------------------------------------------
// CDomBCTester::FileContainer_GetListL
// test method function.
// (other items were commented in a header).
// -----------------------------------------------------------------------------
//
TInt CDomBCTester::FileContainer_GetListL( CStifItemParser& aItem)
{
...
// -----------------------------------------------------------------------------
// CDomBCTester::FileContainer_CidL
// test method function.
// (other items were commented in a header).
// -----------------------------------------------------------------------------
//
TInt CDomBCTester::FileContainer_CidL( CStifItemParser& aItem)
{
...
// -----------------------------------------------------------------------------
//
TInt CDomBCTester::FileContainer_CidErrorL( CStifItemParser& aItem)
{
    ...
    CleanupClosePushL(file1);
    RFile file2;
    User::LeaveIfError(file2.Open(rfs, pInputFile2, EFileRead));
    CleanupClosePushL(file2);
    RFile file3;
    User::LeaveIfError(file3.Open(rfs, pInputFile3, EFileRead));
...
// -----------------------------------------------------------------------------
// CDomBCTester::FileContainer_SizeL
// test method function.
// (other items were commented in a header).
// -----------------------------------------------------------------------------
//
TInt CDomBCTester::FileContainer_SizeL( CStifItemParser& aItem)
{
...
// -----------------------------------------------------------------------------
// CDomBCTester::FileContainer_FileL
// test method function.
// (other items were commented in a header).
// -----------------------------------------------------------------------------
//
TInt CDomBCTester::FileContainer_FileL( CStifItemParser& aItem)
{
...
// -----------------------------------------------------------------------------
// CDomBCTester::FileContainer_NodeTypeL
// test method function.
// (other items were commented in a header).
// -----------------------------------------------------------------------------
//
TInt CDomBCTester::FileContainer_NodeTypeL( CStifItemParser& aItem)
{
...
// -----------------------------------------------------------------------------
// CDomBCTester::FileContainer_RemoveL
// test method function.
// (other items were commented in a header).
// -----------------------------------------------------------------------------
//
TInt CDomBCTester::FileContainer_RemoveL( CStifItemParser& aItem)
{
...
// -----------------------------------------------------------------------------
// CDomBCTester::FileContainer_Remove2L
// test method function.
// (other items were commented in a header).
// -----------------------------------------------------------------------------
//
TInt CDomBCTester::FileContainer_Remove2L( CStifItemParser& aItem)
{
    //check working of Removing FileContainer
...
// -----------------------------------------------------------------------------
// CDomBCTester::FileContainer_Remove3L
// test method function.
// (other items were commented in a header).
// -----------------------------------------------------------------------------
//
TInt CDomBCTester::FileContainer_Remove3L( CStifItemParser& aItem)
{
    //check working of Removing FileContainer
...
// -----------------------------------------------------------------------------
// CDomBCTester::FileContainer_UnlinkL
// test method function.
// (other items were commented in a header).
// -----------------------------------------------------------------------------
//
TInt CDomBCTester::FileContainer_UnlinkL( CStifItemParser& aItem)
{
...
// -----------------------------------------------------------------------------
// CDomBCTester::FileContainer_ReplaceWithL
// test method function.
// (other items were commented in a header).
// -----------------------------------------------------------------------------
//
TInt CDomBCTester::FileContainer_ReplaceWithL( CStifItemParser& aItem)
{
...
// -----------------------------------------------------------------------------
// CDomBCTester::FileContainer_SubstitiuteForL
// test method function.
// (other items were commented in a header).
// -----------------------------------------------------------------------------
//
TInt CDomBCTester::FileContainer_SubstituteForL( CStifItemParser& aItem)
{
...
// -----------------------------------------------------------------------------
// CDomBCTester::FileContainer_CopyL
// test method function.
// (other items were commented in a header).
// -----------------------------------------------------------------------------
//
TInt CDomBCTester::FileContainer_CopyL( CStifItemParser& aItem)
{
...
// -----------------------------------------------------------------------------
// CDomBCTester::FileContainer_Copy2L
// test method function.
// (other items were commented in a header).
// -----------------------------------------------------------------------------
//
TInt CDomBCTester::FileContainer_Copy2L( CStifItemParser& aItem)
{
    //check working of Copying containers
...
// -----------------------------------------------------------------------------
// CDomBCTester::FileContainer_Copy3L
// test method function.
// (other items were commented in a header).
// -----------------------------------------------------------------------------
//
TInt CDomBCTester::FileContainer_Copy3L( CStifItemParser& aItem)
{
    //check working of Copying containers
...
// -----------------------------------------------------------------------------
// CDomBCTester::FileContainer_Copy4L
// test method function.
// (other items were commented in a header).
// -----------------------------------------------------------------------------
//
TInt CDomBCTester::FileContainer_Copy4L( CStifItemParser& aItem)
{
    //check working of Copying containers
...
// -----------------------------------------------------------------------------
// CDomBCTester::FileContainer_CopyToL
// test method function.
// (other items were commented in a header).
// -----------------------------------------------------------------------------
//
TInt CDomBCTester::FileContainer_CopyToL( CStifItemParser& aItem)
{
...
// -----------------------------------------------------------------------------
// CDomBCTester::FileContainer_CloneL
// test method function.
// (other items were commented in a header).
// -----------------------------------------------------------------------------
//
TInt CDomBCTester::FileContainer_CloneL( CStifItemParser& aItem)
{
...
// -----------------------------------------------------------------------------
// CDomBCTester::FileContainer_AdoptNodeL
// test method function.
// (other items were commented in a header).
// -----------------------------------------------------------------------------
//
TInt CDomBCTester::FileContainer_AdoptNodeL( CStifItemParser& aItem)
{
    //check working of Clone containers
...
// -----------------------------------------------------------------------------
// CDomBCTester::FileContainer_SetAsFirstSiblingL
// test method function.
// (other items were commented in a header).
// -----------------------------------------------------------------------------
//
TInt CDomBCTester::FileContainer_SetAsFirstSiblingL( CStifItemParser& aItem)
{
...
// -----------------------------------------------------------------------------
//
TInt CDomBCTester::FileContainer_SetAsLastSiblingL( CStifItemParser& aItem)
{
...
// -----------------------------------------------------------------------------
// CDomBCTester::FileContainer_MoveBeforeSiblingL
// test method function.
// (other items were commented in a header).
// -----------------------------------------------------------------------------
//
TInt CDomBCTester::FileContainer_MoveBeforeSiblingL( CStifItemParser& aItem)
{
...
// -----------------------------------------------------------------------------
// CDomBCTester::FileContainer_MoveAfterSiblingL
// test method function.
// (other items were commented in a header).
// -----------------------------------------------------------------------------
//
TInt CDomBCTester::FileContainer_MoveAfterSiblingL( CStifItemParser& aItem)
{
...
// -----------------------------------------------------------------------------
// CDomBCTester::FileContainer_MoveToL
// test method function.
// (other items were commented in a header).
// -----------------------------------------------------------------------------
//
TInt CDomBCTester::FileContainer_MoveToL( CStifItemParser& aItem)
{
...
// -----------------------------------------------------------------------------
// CDomBCTester::FileContainer_ReconcileNamespacesL
// test method function.
// (other items were commented in a header).
// -----------------------------------------------------------------------------
//
TInt CDomBCTester::FileContainer_ReconcileNamespacesL( CStifItemParser& aItem)
{
