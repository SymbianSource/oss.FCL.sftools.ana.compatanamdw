...
#ifndef __T_DATASIPRSEQHEADER_H__
#define __T_DATASIPRSEQHEADER_H__

#include "t_csipunsignedintheaderbase.h"
#include <siprseqheader.h>

class CT_DataSIPRSeqHeader : public CT_DataSIPUnsignedIntHeaderBase
	{
public:
    static CT_DataSIPRSeqHeader* NewL();
    ~CT_DataSIPRSeqHeader();
...
protected:
    ...
    virtual CSIPUnsignedIntHeaderBase* GetSIPUnsignedIntHeaderBase()const; 
...
private:
    CSIPRSeqHeader* iSIPRSeqHeader;
    TBool iIsOwner;
	};

#endif /* __T_DATASIPRSEQHEADER_H__ */
