/*
* Copyright (c) 1994-2007 Nokia Corporation and/or its subsidiary(-ies). 
* All rights reserved.
...
public:
	...
	IMPORT_C TInt Create(TUint aAtt, TInt aMaxSize, TInt aInitialBottom, TInt aInitialTop, const TDesC* aName, TOwnerType aType=EOwnerProcess);
