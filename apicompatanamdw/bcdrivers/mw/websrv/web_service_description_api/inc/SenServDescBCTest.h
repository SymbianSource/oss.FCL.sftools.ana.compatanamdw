...
NONSHARABLE_CLASS(CSenServDesc) : public CTestModuleBase
    ...
    private:
     ...
     private:    // New methods
         ...
         void MT_CSenCredential_IdL();
         void MT_CSenCredential_ValidUntilL();
         void MT_CSenCredential_SetValidUntilL();
         ...
         void MT_CSenIdentityProvider_NewLL();
         ...
         void MT_CSenIdentityProvider_IsTrustedByLL();
         void MT_CSenIdentityProvider_IsTrustedByL_1L();
         void MT_CSenIdentityProvider_IsDefaultL();
         ...
         void MT_CSenServicePattern_ConsumerPolicyAsXmlLL();
         void MT_CSenServicePattern_MatchesL();
...
//         void MT_CSenXmlServiceDescription_CredentialsL();//need parsing some xml file
         ...
         void MT_CSenXmlServiceDescription_MatchesL();
         ...
         void MT_CSenXmlServiceDescription_AsXmlLL();
         void MT_CSenXmlServiceDescription_AsXmlUnicodeLL();
         void MT_CSenXmlServiceDescription_WriteAsXMLToLL();
         TInt MT_CSenXmlServiceDescription_SetAttributesLL(TTestResult& aResult);
         TInt MT_CSenXmlServiceDescription_TransportPropertiesL(TTestResult& aResult);
         TInt MT_CSenXmlServiceDescription_SetTransportPropertiesL(TTestResult& aResult);
