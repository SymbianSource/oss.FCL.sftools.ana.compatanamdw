...
void CSenServDesc::ConstructL()
    ...
    iLog->Log( KLogStart );
     TInt retVal = 0;
    _LIT(KDir, "c:\\logs\\ServDesc");
    _LIT(KName, "ServDesc.txt");

    //RFileLogger logger;
    retVal = logger.Connect();
    if(retVal == KErrNone)
        {
        logger.CreateLog(KDir, KName, EFileLoggingModeOverwrite);       
        }
...
//-----------------------------------------------------------------------------
// CSenServDesc::SendTestClassVersion
// Method used to send version of test class
//-----------------------------------------------------------------------------
//
void CSenServDesc::SendTestModuleVersion()
	{
	...
	moduleName = _L("SenServDescBCTest.dll");
