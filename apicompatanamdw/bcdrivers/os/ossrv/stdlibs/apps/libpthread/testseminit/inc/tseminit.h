...
#ifndef __TESTSEMINIT_H__
#define __TESTSEMINIT_H__
...
_LIT(KTestSem273, "TestSem273");
_LIT(KTestSem274, "TestSem274");
_LIT(KTestSem689, "TestSem689");
_LIT(KTestSem690, "TestSem690");
_LIT(KTestSem691, "TestSem691");
_LIT(KTestSem692, "TestSem692");
_LIT(KTestSem693, "TestSem693");
_LIT(KTestSem694, "TestSem694");
_LIT(KTestSem695, "TestSem695");
_LIT(KTestSem696, "TestSem696");

class CTestSeminit : public CTestStep
	{
public:
	~CTestSeminit(); 
	CTestSeminit(const TDesC& aStepName);
