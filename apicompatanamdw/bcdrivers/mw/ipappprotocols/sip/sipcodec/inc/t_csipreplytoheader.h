...
#ifndef __T_DATASIPREPLYTOHEADER_H__
#define __T_DATASIPREPLYTOHEADER_H__

#include "t_csipaddressheaderbase.h"
#include <sipreplytoheader.h>

class CT_DataSIPReplyToHeader : public CT_DataSIPAddressHeaderBase
	{
public:
    static CT_DataSIPReplyToHeader* NewL();
    ~CT_DataSIPReplyToHeader();
...
private:
    CSIPReplyToHeader* iSIPReplyToHeader;
    TBool iIsOwner;
	};

#endif /* __T_DATASIPREPLYTOHEADER_H__ */
