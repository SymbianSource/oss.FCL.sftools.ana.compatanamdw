...
-------------------------------------------------------------------------------
*/
TInt CDownloadMgrBCTest::InteractionsOkToExitLTest( TTestResult& aResult )
    {
...
-------------------------------------------------------------------------------
*/
TInt CDownloadMgrBCTest::InteractionsPrepareToExitWithViewIdTest( TTestResult& aResult )
    {
    /* Simple server connect */
    _LIT( KDefinition ,"State");
...
-------------------------------------------------------------------------------
*/
TInt CDownloadMgrBCTest::InteractionsPrepareToExitTest( TTestResult& aResult )
    {
    /* Simple server connect */
    _LIT( KDefinition ,"State");
...
-------------------------------------------------------------------------------
*/
TInt CDownloadMgrBCTest::InteractionsHandleDownloadLTest( TTestResult& aResult )
    {
    /* Simple server connect */
    _LIT( KDefinition ,"State");
