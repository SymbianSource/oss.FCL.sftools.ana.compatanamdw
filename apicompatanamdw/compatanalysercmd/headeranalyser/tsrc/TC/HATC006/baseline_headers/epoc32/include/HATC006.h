...
public:
    ...
    IMPORT_C void ExpPublicFunc1(int a);
    IMPORT_C int ExpPublicFunc2();

protected:
    IMPORT_C void ExpProtectedFunc1(int a);
    IMPORT_C int ExpProtectedFunc2();

private:
    IMPORT_C void ExpPrivateFunc1(int a);
    IMPORT_C int ExpPrivateFunc2();
};
...
public:
    ...
    inline int InlPublicFunc2();

protected:
    inline void InlProtectedFunc1(int a);
    inline int InlProtectedFunc2();

private:
    inline void InlPrivateFunc1(int a);
    inline int InlPrivateFunc2();
};
