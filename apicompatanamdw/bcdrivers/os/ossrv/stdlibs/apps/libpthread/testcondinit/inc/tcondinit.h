...
#ifndef __TESTCONDINIT_H__
#define __TESTCONDINIT_H__
...
_LIT(KTestCond401, "TestCond401");
_LIT(KTestCond403, "TestCond403");
_LIT(KTestCond404, "TestCond404");
_LIT(KTestCond668, "TestCond668");
_LIT(KTestCond670, "TestCond670");
_LIT(KTestCond671, "TestCond671");
_LIT(KTestCond672, "TestCond672");
_LIT(KTestCond673, "TestCond673");


class CTestCondinit : public CTestStep
	{
public:
	~CTestCondinit(); 
	CTestCondinit(const TDesC& aStepName);
