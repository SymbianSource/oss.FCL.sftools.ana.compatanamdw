...
-------------------------------------------------------------------------------
*/
TInt CDownloadMgrBCTest::RegistryNewLTest( TTestResult& aResult )
    {
...
-------------------------------------------------------------------------------
*/
TInt CDownloadMgrBCTest::RegistryRegisterUserInteractionsLTest( TTestResult& aResult )
    {
    /* Simple server connect */
    _LIT( KDefinition ,"State");
...
-------------------------------------------------------------------------------
*/
TInt CDownloadMgrBCTest::RegistryRegisterDownloadsListLTest( TTestResult& aResult )
    {
    /* Simple server connect */
    _LIT( KDefinition ,"State");
